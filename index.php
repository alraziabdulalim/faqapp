        ...
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="./index.php" class="-m-1.5 p-1.5">
                    ...
                    <span
                        class="block font-bold text-lg bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text">Feedback
                        App</span>
                </a>
            </div>
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <div class="space-x-4">
                    <a href="./feedback.php" class="text-sm font-semibold leading-6 text-gray-900">Feedback</a>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="sr-only">TrueUser</span>
                        <span
                            class="block font-bold text-xl bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text">FeedBack
                            App</span>
                    </a>
